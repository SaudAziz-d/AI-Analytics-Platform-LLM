...
| Screen | Description |
|--------|-------------|
| Overview Dashboard | KPI summary cards, revenue trend, segment donut, source status, AI insight feed |
| KPI Analytics | Detailed KPI metrics with sparklines, segment breakdown table, period filters |
| AI Insights | Full insights feed with confidence scores, categorized by forecast / risk / opportunity / ops |
| Predictions | ML forecast charts, churn risk heatmap, anomaly timeline |
| Data Sources | Connector management, sync schedules, health monitoring |
| Reports | Scheduled report builder, PDF export, executive brief generator |
